    ...
    <PageContainer className="py-10" as="main">
      <section className="flex flex-col gap-6">
        ...
        <Link
          ...
          className="inline-flex min-h-touch items-center justify-center self-start rounded bg-accent-500 px-6 text-base font-semibold text-on-accent shadow-sm transition-colors hover:bg-accent-600"
        >
          {t('retryCta')}
        </Link>
      </section>
